...
# Solution Overview
For more detail about what takes place behind the scenes in this deployment please see the [Solution Overview](https://github.com/PaloAltoNetworks/aws-transit-vpc/blob/master/documentation/solution_overview.md)
